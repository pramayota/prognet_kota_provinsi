      ...
      <div class="col-md-8">
        <div class="card" style="background-color: #fefefe;">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category">Edit Data Provinsi </p>
          </div>
          <div class="card-body">
            <form method="post" action="{{Route('saveEditProvinsi', $provinsi->id)}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="bmd-label-floating" style="color:#000;">Nama Provinsi</label>
                    <input name="name" type="text" class="form-control @error ('name') is-invalid @enderror" value="{{$provinsi->name}}">

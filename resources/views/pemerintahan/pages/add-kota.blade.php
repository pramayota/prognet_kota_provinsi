      ...
      <div class="col-md-8">
        <div class="card" style="background-color: #fefefe;">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category">Input data Kota/Kabupaten </p>
          </div>
          <div class="card-body">
            <form method="post" action="{{ route('saveAddKota') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="bmd-label-floating" style="color:#000;">Nama Kota/Kabupaten</label>
                    <input name="name" type="text" class="form-control @error ('name') is-invalid @enderror" placeholder="Masukkan nama">
